...
const Mentorship = () => {
    return (
        <div className='relative my-10 mb-72'>
            ...
            <div className='flex flex-col md:flex-row gap-10 z-50 top-3 absolute right-52 left-auto'>
                <div className='flex-1 pt-10'>
                    <img className='h-[500px] rounded-3xl' src={img} alt="" />
                </div>
                <div className='flex-1 pt-20 space-y-5'>
